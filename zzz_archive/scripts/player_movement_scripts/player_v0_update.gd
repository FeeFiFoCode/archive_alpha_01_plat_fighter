...
# General Grounded Parameters
const TRACTION = -0.06
var traction = TRACTION

var current_speed = 0.04
var accel

# Walk - Grounded Movement ( Speed, Acceleration, Traction )
## Constants
const WALK_SPEED_MAX = 1.6
const WALK_ACCEL_SCALE = 0.2
const WALK_ACCEL_BASE = 0.1

## Variables
var walk_speed_max = WALK_SPEED_MAX
var walk_accel_scale = WALK_ACCEL_SCALE
var walk_accel_base = WALK_ACCEL_BASE

## Target Speed Formula
var target_speed = current_speed
var walk_standing_accel = 0.0

### physics_process() [ in walk state ; adjusted for deadzone??? ]
### target_speed = walk_speed_max * stick_x
### walk_standing_accel = walk_accel_base + ( stick_x * walk_accel_scale )
###	accel = 0.5 * walk_standing_accel * ( 1 - current_speed/target_speed )
